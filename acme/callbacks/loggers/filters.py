...
class NoneFilter(base.BaseLoggerCallback):
    """Logger which writes to another logger, filtering any `None` values."""

    def __init__(self, to: base.BaseLoggerCallback):
...
class TimeFilter(base.BaseLoggerCallback):
    """Logger which writes to another logger at a given time interval."""

    def __init__(self, to: base.BaseLoggerCallback, time_delta: float):
        """Initializes the logger.
